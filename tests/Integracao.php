...
class Integracao {
    ...
    public function criaImovel($email_corretor,$tipo,$servico,$valor,$cep,$endereco,$numero,$bairro,$cidade,$uf){
        $dados = array( 'email_corretor' => $email_corretor, 'tipo' => $tipo, 'servico' => $servico, 'valor' => $valor,'cep' => $cep,'endereco' => $endereco,
